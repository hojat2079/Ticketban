...
//padding
const EdgeInsets appbarAuthPadding = EdgeInsets.symmetric(
  horizontal: 20,
  vertical: 16,
);
...
const double defaultBorderSizeOuterGradiantAvatar = 2;
const double defaultBorderSizeInnerGradiantAvatar = 2;
